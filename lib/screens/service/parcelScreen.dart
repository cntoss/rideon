...
class _ParcelScreenState extends State<ParcelScreen> {
                  ...
                  child: !_showConfirmation ? Form(
                                               ...
                                               onPlacePicked: (r) {
                                                 ...
                                                 setState(() {
                                                   if (r.name
                                                     ...
                                                     _toController.text = r
                                                             .name +
                                                         ' ' +
                                                         r.formattedAddress;
                                                   }
                                                 });
                                                 _toAddress = LocationDetail.fromPickResult(r);
                                               })));
                                 },
                                 child: TextFormField(
                                   enabled: false,
                       ...
                       Column(
                         ...
                         Text("Delivery Information"),
                           ...
                           Text("Estimated Distance ${distanceResponse.results.first.elements.first.distance}"),
  ...
  _continueToDelivery() async {
    ...
    distanceResponse = await  GoogleDistanceMatrix(apiKey: googleAPIKey).distanceWithLocation([_fromAddress.geometry.location], [_toAddress.geometry.location]);
